...
function appendMessage(m) {
    ...
    if (m.file_name) {
        html += '<a href="/uploads/chat/' + encodeURIComponent(m.file_name) + '" target="_blank" class="text-white d-block"><i class="bi bi-file-earmark me-1"></i>' + $('<div>').text(m.file_name).html() + '</a>';
    } else {
